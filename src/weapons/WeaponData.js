...
export const WEAPON_EVOLUTIONS = {
  ...
  knife: {
    ...
    // dmgMult 原本是 1.6，跟數量倍率(1.8)、冷卻倍率(1.3)疊在一起變成 3.6 倍的
    // 總輸出漲幅，是所有武器進化裡最誇張的一個（其餘都落在 2.2~2.7 倍），
    // 也讓飛刀的兩個融合武器（電擊飛刃/血肉風暴）打王輸出反而輸給飛刀自己
    // 單獨進化。降到 1.2，總漲幅回落到約 2.7 倍，貼近火球術修正後的比例，
    // 冷卻/數量不動，維持「進化後打更快更多刀」的手感。
    dmgMult: 1.2, extraMult: 1.8, cooldownMult: 1.3,
